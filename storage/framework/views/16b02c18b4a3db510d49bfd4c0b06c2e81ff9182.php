                ...
                <div class="slide-container1 swiper" data-aos="fade-down"
                    ...
                    <div class="slide-content">
                        <div class="card-wrapper swiper-wrapper">
                            <?php $__empty_1 = true; $__currentLoopData = $youtubeVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="card swiper-slide">
                                    
                                    <iframe src="https://www.youtube.com/embed/<?php echo e($yt->id->videoId); ?>">
                                    </iframe>

                                    <h4>
                                        <?php echo e($yt->snippet->title); ?>

                                    </h4>
                                    <p>
                                        <?php echo e($yt->snippet->description); ?>

                                    </p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <h3 class="text-center">لايوجد فيديوهات حاليا</h3>
                            <?php endif; ?>
                        </div>
                    </div>
