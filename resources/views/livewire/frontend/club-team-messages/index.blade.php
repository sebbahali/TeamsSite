<div class="container">
    <div class="row">
        <div class="col-12">
            <x-card.main title="رسائل النادي">
                <div class="form-inline d-flex align-items-center border-bottom mb-2">
                    ...
                    <div class="form-check mx-sm-2 align-self-end">
                        <a href="{{ route('frontend.club-team-messages.create') }}" class="btn btn-primary btn-sm" title="ارسال رسالة جديدة">
                ...
                <div class="preview-list">
                    @forelse ($messages as $message)
                        <a href="{{ route('frontend.club-team-messages.show', $message->id) }}"
                            ...
                            <div
                                ...
                                <p style=font-size:12px class="text-gray ellipsis mb-0">
                                 <i style=font-size:12px class="mdi mdi-account-circle"> من: {{ $message->sender()->name }}</i>
                                    @if ($message->status)
