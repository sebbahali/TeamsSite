        ...
        <div class="col-12">
            <x-card.main title="الرسائل">
                <div class="form-inline d-flex align-items-center border-bottom mb-2">
                    ...
                    <div class="form-check mx-sm-2 align-self-start">
                        <a href="{{ route('frontend.competition-issues.message-create', ['competition' => $competition]) }}" class="btn btn-primary btn-sm" title="ارسال رسالة جديدة">
                ...
                <div class="preview-list">
                    @forelse ($issues as $issue)
                        <a href="{{ route('frontend.competition-issues.show', ['competition' => $competition, 'competitionIssue' => $issue]) }}"
                    ...
                    @empty
                        <div class="alert alert-info mt-3">لا يوجد رسائل لعرضها لعرضها</div>
                    @endforelse
                </div>
