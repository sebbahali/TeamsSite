            ...
            <x-card.main title="الاحتجاجات">
                <div class="form-inline d-flex align-items-center border-bottom mb-2">
                    ...
                    <div class="form-check mx-sm-2 align-self-start">
                        <a href="{{ route('frontend.competition-issues.create', ['competition' => $competition]) }}" class="btn btn-primary btn-sm" title="ارسال احتجاج جديد">
