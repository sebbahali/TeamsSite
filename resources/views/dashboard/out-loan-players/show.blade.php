            ...
            <div class="col-12">
                <x-card.main title="لاعب معار خارجيا">
                    <div class="form-inline d-flex align-items-center border-bottom mb-2">
                        <a class="btn btn-danger btn-sm mb-2" href="{{ route('dashboard.out-loan-players.index') }}" title="رجوع">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    @if ($outLoanPlayer->status == \App\Enums\LoanOutPlayerStatus::SendToClub)
                                        <a href="{{ route('dashboard.out-loan-players.approve', $outLoanPlayer) }}" class="btn btn-primary btn-sm mx-1" title="الموافقة">
                                            <i class="mdi mdi-check"></i>
                                        </a>
                                        <a href="{{ route('dashboard.out-loan-players.cancel', $outLoanPlayer) }}" class="btn btn-danger btn-sm mx-1" title="الغاء">
