...
<body class="rtl">
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="container-fluid d-flex justify-content-between">
                        <span class="d-block text-center text-sm-start d-sm-inline-block">جميع الحقوق محفوظة ©
                            {{ date('Y') }} ل{{ env('APP_NAME') }}</span>
    ...
    {{-- include js file --}}
    <x-dashboard.includes.js />

    <x-notifications />

    <x-delete-confirmation />

    <x-dashboard.poup-notefication-menu />
        @yield('script')
</body>
