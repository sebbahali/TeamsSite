...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        {{-- <a class="navbar-brand brand-logo" href="{{ route('frontend.index') }}">
            <img src="{{ getImg('teams/'.team()->logo) }}" alt="logo" /> <span>{{ team()->name }}</span>
        </a> --}}
        <a class="navbar-brand brand-logo-mini" href="{{ route('frontend.index') }}">
            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                    ...
                    <div class="nav-profile-text">
                        <p class="mb-1">{{ auth()->guard('team')->user()->user_fullname }}</p>
                    </div>
                </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    @forelse ($messages as $message)
                        <a href="{{ route('frontend.message-notefications.show', $message->id) }}" class="dropdown-item preview-item">
                    ...
                    <h6 class="p-3 mb-0 text-center">
                        <a style=font-size:13px href="{{  route('frontend.message-notefications.index') }}">كل التنبيهات</a>
                    </h6>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    @forelse ($notefications as $notefication)
                        <a href="{{ route('frontend.notefications.show', $notefication->id) }}" class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <div class="preview-icon bg-success">
                    ...
                    <h6 class="p-3 mb-0 text-center">
                        <a style=font-size:13px href="{{  route('frontend.notefications.index') }}">كل الاشعارات</a>
                    </h6>
                </div>
            </li>
