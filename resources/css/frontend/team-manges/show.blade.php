<x-frontend.layouts.app>
    <x-slot name="title">ادارات الفريق</x-slot>

    <div class="container">
        <div class="row">
            <div class="col-12">
                <x-card.main title="ادارات الفريق">

                    <div class="form-inline d-flex align-items-center border-bottom mb-2">
                        @if (!$teamMange->isActive())
                        ...
                        @else
                            <div class="form-check mx-sm-2">
                                <a href="{{ route('frontend.team-mange-members.create', $teamMange->id) }}"
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mt-3">
                                                        <a href="{{ route('frontend.team-mange-members.edit', $member->id) }}" class="btn btn-info btn-sm" title="تعديل"><i class="mdi mdi-grease-pencil"></i></a>
                                                        <form id='delteForm' action="{{ route('frontend.team-mange-members.destroy', $member->id) }}" method="post" style="display:inline-block">
                                                            @csrf
                                                            @method('DELETE')
