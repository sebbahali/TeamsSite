            ...
            <x-card.main title="الاحتجاجات">
                <div class="form-inline d-flex align-items-center border-bottom mb-2">
                    ...
                    <div class="form-check mx-sm-2 align-self-end">
                        <a href="{{ route('dashboard.competition-issues.create', ['competition' => $competition]) }}" class="btn btn-primary btn-sm" title="اضافة احتجاج">
                ...
                <div class="preview-list">
                    ...
                    @empty
                        <div class="alert alert-info mt-3">لا توجد احتجاجات لعرضها </div>
                    @endforelse
                </div>
