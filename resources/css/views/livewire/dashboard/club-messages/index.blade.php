            ...
            <x-card.main title="رسائل النادي">
                <div class="form-inline d-flex align-items-center border-bottom mb-2">
                    ...
                    <div class="form-check mx-sm-2 align-self-end">
                        <a href="{{ route('dashboard.club-messages.create') }}" class="btn btn-primary btn-sm" title="ارسال رسالة جديدة">
               ...
               <div style=background-color:GhostWhite>
                <div class="preview-list">
                    @forelse ($messages as $message)
                        <a href="{{ route('dashboard.club-messages.show', $message->id) }}"
                            ...
                            <div
                                ...
                                <p style=font-size:12px class="text-gray ellipsis mb-0">
                                 <i style=font-size:12px class="mdi mdi-account-circle"> من: {{ $message->senderUser()->name }}</i> 
                                    @if ($message->status)
