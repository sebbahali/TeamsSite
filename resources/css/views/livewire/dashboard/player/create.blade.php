            ...
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="submitForm" method="POST" class="forms-sample mt-4">
                        ...
                        <div class="form-group">
                            <label for="register_number">رقم القيد</label>
                            <input type="text" wire:model="register_number" value="{{ old('register_number') }}" class="form-control"
                                id="register_number" placeholder="رقم القيد">
                        ...
                        <div>
                            <x-form.group label="نوع التسجيل" for="register_type" :error="$errors->first('register_type')">
                                <x-form.select wire:model="register_type" id="register_type" name="register_type">
                                    <option value="">الرجاء الاختيار</option>
                                    <option value="join">منتسب</option>
                                    <option value="loan">معار</option>
                                </x-form.select>
                            </x-form.group>

                            @if ($register_type == "loan")
                                <x-form.group label="اختر الفريق الاساسي" for="basic_team" :error="$errors->first('basic_team')">
                                    <x-form.select wire:model.defer="basic_team" id="basic_team" name="basic_team" placeholder="الرجاء اختيار الفريق الاساسي">
                                        <option value="">اختر الفريق</option>
                                        @foreach ($teams as $team)
                                            <option value="{{ $team->id }}">{{ $team->name }}</option>
                                        @endforeach
                                ...
                                <x-form.group label="تاريخ البداية" for="start" :error="$errors->first('start')">
                                    <x-form.input type="date" wire:model="start" id="start" name="start" value="{{ old('start') ?? '' }}" placeholder="تاريخ البداية" />
                                </x-form.group>
                                <x-form.group label="تاريخ النهاية" for="end" :error="$errors->first('end')">
                                    <x-form.input type="date" wire:model="end" id="end" name="end" value="{{ old('end') ?? '' }}" placeholder="تاريخ النهاية" />
                                </x-form.group>
