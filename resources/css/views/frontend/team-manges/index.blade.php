            ...
            <div class="col-12">
                <x-card.main title="ادارات الفريق">
                    ...
                    <div class="form-inline d-flex align-items-center border-bottom mb-2">
                        @if (\App\Models\TeamMange::existActiveMange())
                        ...
                        @else
                            <div class="form-check mx-sm-2">
                                <a href="{{ route('frontend.team-manges.create') }}" class="btn btn-primary btn-sm"
                            ...
                            <tbody>
                                @forelse ($manges as $index => $mange)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info btn-sm" href="{{ route('frontend.team-manges.show', $mange->id) }}" title="عرض"><i class="mdi mdi-eye"></i></a></td>
                                    </tr>
