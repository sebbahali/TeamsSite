@if ($messages > 0 || $notefications > 0)
    <nav class="menu">
        ...
        @if ($notefications > 0)
            <a href="{{ route('dashboard.notefications.index') }}" class="menu-item d-flex justify-content-center blue text-decoration-none">
        ...
        @if ($messages)
            <a href="{{  route('dashboard.message-notefications.index') }}" class="menu-item d-flex justify-content-center green text-decoration-none">
