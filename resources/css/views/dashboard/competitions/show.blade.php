                ...
                <x-card.main title="المسابقات - {{ $competition->name }}">
                    <div class="form-inline d-flex align-items-center border-bottom mb-2">
                        ...
                        @role('superadministrator')
                            ...
                            @ableTo('update-competitions')
                                <a class="btn btn-info btn-sm mb-2" href="{{ route('dashboard.competitions.edit', $competition) }}" title="تعديل المسابقة">
