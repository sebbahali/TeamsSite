<x-dashboard.layouts.app>
    ...
    <div class="row">
        @role('superadministrator')
            <div class="col-md-4 col-sm-6 stretch-card grid-margin">
                <a href="{{ route('dashboard.teams.index') }}" class="text-decoration-none d-block w-100">
            ...
            <div class="col-md-4 col-sm-6 stretch-card grid-margin">
            <a href="{{ route('dashboard.players-search.index') }}" class="text-decoration-none d-block w-100">
            ...
            <div class="col-md-4 col-sm-6 stretch-card grid-margin">
                <a href="{{ route('dashboard.players.request-index') }}" class="text-decoration-none d-block w-100">
            ...
            <div class="col-md-4 col-sm-6 stretch-card grid-margin">
                <a href="{{ route('dashboard.transfer-players.index') }}" class="text-decoration-none d-block w-100">
                    <div class="card bg-gradient-info card-img-holder text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
            ...
            <div class="col-md-4 col-sm-6 stretch-card grid-margin">
                <a href="{{ route('dashboard.loan-players.index') }}" class="text-decoration-none d-block w-100">
                    <div class="card bg-gradient-success card-img-holder text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
        ...
        @ableTo('read-mettings')
            <div class="col-md-4 col-sm-6  stretch-card grid-margin">
                <a href="{{ route('dashboard.mettings.index') }}" class="text-decoration-none d-block w-100">
                    <div class="card bg-gradient-danger card-img-holder text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
        ...
        @ableTo('read-competitions')
            <div class="col-md-4 col-sm-6  stretch-card grid-margin">
                <a href="{{ route('dashboard.competitions.index') }}" class="text-decoration-none d-block w-100">
                    <div class="card bg-gradient-danger card-img-holder text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
    ...
    <div class="row">
        @role('superadministrator')
            <div class="col-md-6">
                <x-card.main title="احصائيات اللاعبين">
        ...
        @ableTo('read-competitions')
            <div class="col-md-6">
                <x-card.main title="احصائيات المسابقات">
                    <div style="height: 300px" id="competitionStateChart">
                        {!! $competitionChart->container() !!}
                        {!! $competitionChart->script() !!}
                    </div>
                </x-card.main>
            </div>
        @endableTo
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="dashboard/images/faces/face1.jpg" class="me-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="dashboard/images/faces/face2.jpg" class="me-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="dashboard/images/faces/face3.jpg" class="me-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="dashboard/images/faces/face4.jpg" class="me-2"
                                            alt="image"> John Doe
                                    </td>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-6 pe-1">
                            <img src="dashboard/images/dashboard/img_1.jpg"
                                class="mb-2 mw-100 w-100 rounded" alt="image">
                            <img src="dashboard/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded"
                                alt="image">
                        </div>
                        <div class="col-6 ps-1">
                            <img src="dashboard/images/dashboard/img_2.jpg"
                                class="mb-2 mw-100 w-100 rounded" alt="image">
                            <img src="dashboard/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded"
                                alt="image">
                        </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                        <img src="dashboard/images/faces/face3.jpg" class="img-sm rounded-circle me-3"
                            alt="image">
